...
Put           | Breedte put                         | 300 <= Waarde <= 4000 mm     | Datatype     | **N**                              | **N**                              |  <span style="color:red">H</span> 
...
Leiding       | Hoogte leiding                      | 63 <= Waarde <= 4000 mm      | Datatype     | **N**                              | **N**                              |  <span style="color:red">H</span> 
Leiding       | Breedte leiding                     | 63 <= Waarde <= 4000 mm      | Datatype     | **N**                              | **N**                              |  <span style="color:red">H</span> 
Put/Lei       | Einddatum                           |                              | Datatype
Put/Lei       | Begindatum                          |                              | Datatype     | <span style="color:green">L</span> | <span style="color:green">L</span> 
Leiding       | Wanddikte                           |                              | Datatype     |                                    |                                    |  <span style="color:red">H</span> 
...
Put           | Lengte put                          | 300 <= Waarde <= 4000 mm     | Datatype     | **N**                              | **N**                              |  <span style="color:red">H</span> 
Put/Lei       | Datum maatregel                     |                              | Datatype
Leiding       | Lengte leiding                      | 1 <= Waarde <= 75 m          | Datatype     | <span style="color:red">H</span>   | <span style="color:red">H</span>   |  <span style="color:red">H</span>  
Leiding       | Lengte buisdeel                     |                              | Datatype
Put           | Maaiveld put                        | -20 <= Waarde <= 300 m       | Datatype     | **N**                              |                                    |  <span style="color:red">H</span> 
Leiding       | Maaiveld beginpunt leiding          | -20 <= Waarde <= 300 m       | Datatype
Leiding       | Maaiveld eindpunt leiding           | -20 <= Waarde <= 300 m       | Datatype
Put           | Putoriëntatie / Positie / X         | -7000 <= Waarde <= 300000 m  | Datatype     | **N**                              | **N**                              |  <span style="color:red">H</span> 
...
Leiding       | B.o.b. beginpunt leiding            | -20 <= Waarde <= 300 m       | Datatype     | <span style="color:red">H</span>   | <span style="color:red">H</span>   |  <span style="color:red">H</span> 
Leiding       | B.o.b. eindpunt leiding             | -20 <= Waarde <= 300 m       | Datatype     | <span style="color:red">H</span>   | <span style="color:red">H</span>   |  <span style="color:red">H</span> 
