...
1.2	Aandachtpunten bij export van GWSW.orox bestand
...
o	Hulppunt als puttype op termijn verwijderen (Obsurv)
o	Randvoorziening specificeren naar bijvoorbeeld Lamellenfilter, Retentievoorziening (Obsurv)
o	MechanischRioolstelsel, VrijvervalRioolleiding en Deksel specificeren naar bijvoorbeeld Drukriolering enzovoort. (Kikker)
...
1.3	Aandachtspunten bij upload naar GWSW-Dataset
